...
| `wave-research` | `presets/wave-research.yml` | `planner`, `researcher` (x3), `synthesizer` | `research.start` | `LOOP_COMPLETE` | Parallel research with synthesis (wave-enabled) |
...
Examples: `wave-review`, `wave-research`
